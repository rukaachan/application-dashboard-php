                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            ...
                                            <li><button class="detail"><a href="<?= BASE ?>detail&id=<?= $row["id_kelas"]; ?>">
                                                        <i class='bx bxs-book'></i>Detail
                                                    </a></button></li>
                                            <li><button class="edit"><a href="<?= BASE ?>edit&id=<?= $row["id_kelas"]; ?>">
                                                        <i class='bx bx-edit'></i> Edit</a></button></li>
                                            <li><button class="hapus"><a href="<?= BASE ?>hapus&id=<?= $row["id_kelas"]; ?>" onclick=" return confirm('yakin?');"><i class='bx bxs-trash'></i> Hapus</a></button></li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr></tr>
