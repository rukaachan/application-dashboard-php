                        ...
                        <?php foreach ($data as $row) : ?>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <!-- option detail/edit/hapus -->
                                            <li><button class="detail"><a href="<?= BASE ?>detail&id=<?= $row["id_anggota"]; ?>">
                                                        <i class='bx bxs-book'></i>Detail
                                                    </a></button></li>
                                            <li><button class="edit"><a href="<?= BASE ?>edit&id=<?= $row["id_anggota"]; ?>">
                                                        <i class='bx bx-edit'></i> Edit</a></button></li>
                                            <li><button class="hapus"><a href="<?= BASE ?>hapus&id=<?= $row["id_anggota"]; ?>" onclick=" return confirm('yakin?');"><i class='bx bxs-trash'></i> Hapus</a></button></li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr></tr>
